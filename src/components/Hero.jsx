// Hero.jsx — Full-height landing section with name, title, CTA and social links
...
function Hero() {
  return (
    <section id="hero" className="hero">
      ...
      <p className="hero__title">BCA Student &amp; Frontend Developer</p>

            <p className="hero__desc">
        Passionate about building modern, responsive web applications with clean code,
        intuitive design, and seamless user experiences—turning ideas into functional,
        user-friendly products that focus on performance, usability, and elegant interfaces.
      </p>
      {/* CTA Buttons */}
      <div className="hero__btns">
        {/* Replace href="#" with the actual resume PDF link */}
